...
int64 nChainStartTime = 1460713589;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BitExchange
    bool fStrictPayToScriptHash = true; // Always active in BitExchange
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "fWorkL Exch empty ange mapBlockIndex BitExchange";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 724600 : 724600;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0xfce23a2e439f40382322896b2a0a9d2617ff2c6a62b3354fb3cecdc2e72603d9"));
...
unsigned char pchMessageStart[4] = { 0xcf, 0xeb, 0x8a, 0xdb };
